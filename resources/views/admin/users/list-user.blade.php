        ...
        <div class="box-body table-responsive no-padding">
            <form action="" method="post">
                ...
                <span class="pull-right">Tổng số bản ghi tìm thấy: <span
                        style="font-size: 15px;font-weight: bold;">{{ $users->count() }}</span></span>
                <div class="clearfix"></div>
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href="{{ route('route_Backend_User_Detail',['id'=>$user->id]) }}"
                                                           style="white-space:unset;text-align: justify;">
                                        {{ $user->name }} <i class="fa fa-edit"></i></a></td>
                                <td class="text-center">
                                    <img id="mat_truoc_preview"
                                         src="{{ $user->image?''.Storage::url($user->image):'https://png.pngtree.com/element_our/png/20181206/users-vector-icon-png_260862.jpg' }}"
                                         alt="your image"
                                ...
                                <td class="text-center">
                                    <a href="{{ route('route_Backend_User_Delete',['id'=>$user->id]) }}" class="btn btn-danger btn-sm" onclick="return confirm('Bạn có muốn xóa?')"><i class="bi bi-calendar-x-fill" style="color:white;"></i>
                                        Delete</a>
                                </td>
                            </tr>
                        @endforeach
