            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                            ...
                            <div class="col-md-9 col-sm-8">
                                <select class="form-select" aria-label="Default select example" name="id_role">
                                    ...
                                    @foreach($roles as $role)
                                        <option value="{{ $role->id }}" {{ ($role->id == $objItem->id_role) ? 'selected' : '' }}>{{ $role->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 col-sm-4 control-label">Ảnh người dùng <span class="text-danger">(*)</span></label>
                            <div class="col-md-9 col-sm-8">
                                <div class="row">
                                    <div class="col-xs-6">
                                        <img id="mat_truoc_preview"
                                             src="{{ $objItem->image?''.Storage::url($objItem->image):'https://png.pngtree.com/element_our/png/20181206/users-vector-icon-png_260862.jpg' }}"
                                             alt="your image"
...
{{--                        </div>--}}
            ...
            <div class="text-center">
                ...
                <a href="{{ route('router_BackEnd_ListUser_index') }}" class="btn btn-default">Cancel</a>
            </div>
            <!-- /.box-footer -->
        </form>
