                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{ $objUser->image?''.Storage::url($objUser->image):'https://png.pngtree.com/element_our/png/20181206/users-vector-icon-png_260862.jpg' }}" class="user-image" alt="User Image">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="{{ $objUser->image?''.Storage::url($objUser->image):'https://png.pngtree.com/element_our/png/20181206/users-vector-icon-png_260862.jpg' }}" class="img-circle" alt="User Image">
                </div>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                <li class=" active menu-open ">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ url('/admin/users') }}"><i class="fa fa-user-circle-o"></i> Người dùng</a></li>
                        <li><a href="{{ url('/roles') }}"><i class="fa fa-user-o"></i> Vai trò</a></li>
                    </ul>
                </li>
                <li class=" active menu-open ">
                    <a href="#"><i class="fa fa-user"></i> <span>Sản phẩm</span></a>
                    <ul class="treeview-menu">
                        <li><a href="{{ url('/categories') }}"><i class="fa fa-circle-o"></i> Danh mục sản phẩm</a></li>
                        <li><a href="{{ url('/products') }}"><i class="fa fa-circle-o"></i> Sản phẩm</a></li>
                        <li><a href="{{ url('/promotions') }}"><i class="fa fa-circle-o"></i> Khuyến mãi</a></li>
                    </ul>
                </li>
                <li class=" active menu-open ">
                    <a href="#"><i class="fa fa-user"></i> <span>Hóa đơn</span></a>
                    <ul class="treeview-menu">
                        <li><a href="{{ url('/bills') }}"><i class="fa fa-circle-o"></i> Danh sách hóa đơn</a></li>
                    </ul>
                </li>
                <li class=" active menu-open ">
                    <a href="#"><i class="fa fa-user"></i> <span>Banners</span></a>
                    <ul class="treeview-menu">
                        <li><a href="{{ url('/banners') }}"><i class="fa fa-circle-o"></i> Danh sách banner</a></li>
                    </ul>
                </li>
            </ul>
        </section>
